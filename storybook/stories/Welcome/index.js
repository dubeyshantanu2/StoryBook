  ...
  render() {
    return (
      <View style={this.styles.wrapper}>
        <Text style={this.styles.header}>Welcome to Suggaa Components Storybook.</Text>
        <Text style={this.styles.content}>
          This is a UI Component development environment for all 3 Suggaa applications. Here you can
